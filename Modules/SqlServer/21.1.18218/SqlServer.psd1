...
* Fixed an issue in Invoke-SqlAssessment where a wrong error message was
  displayed for some inaccessible databases.
* Fixed an issue in Invoke-SqlAssessment where an incomplete error message
  was displayed in case of division by zero.
* Fixed the FullBackup assessment check: alert threshold unit changed from hours to days.
* Fixed an issue in Invoke-SqlAssessment with messages for CPU utilization checks.

## 21.1.18209
Fixes:
* Fixed an issue in the Restore-SqlDatabase cmdlet where the -AutoRelocateFile
  switch was not working when restoring from URL (the -SqlCredential parameter
  was not properly passed around)

Updates:
* Updated Add-SqlAzureAuthenticationContext to register the SqlColumnEncryptionAzureKeyVaultProvider
  with the driver when invoked.

## 21.1.18206
Fixes:
* Fixed column encryption (Always Encrypted) of tables containing classified
  columns (Data Discovery & Classification).

Updates:
* Updated output of the Invoke-SqlAssessment cmdlet for the case of empty check list.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBlWBvRQhfXozYQ
# cHCUBBKV142WdtdtOGbAkxdgGD+ri6CCDYUwggYDMIID66ADAgECAhMzAAABUptA
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEII37
# 2lHYUdphrfZNnT6djVJGmu59nuvA8HcSXzW8tzN+MG4GCisGAQQBgjcCAQwxYDBe
...
# BgkqhkiG9w0BAQEFAASCAQAq7QiqrhOI2Cr8mwJm6udxr6kVjvtbDDx8DFJ1Ller
# Wffka1acxEL/uya5CqO5Z5Gx1gOH+CCRCFcu+K6D2Atb1Jhl6du1b130vakUdq0x
# kqKMlNXgXrbTPMzX23pw+ATvHyjYPOcOkF1Y5+HuudSb4MyjC1xyqT03p+q5fqDe
# g6YnEZbMXL3mt7KOf3vaRnMeEreyG4qop0ZOE2TFfAJzM4aUvzGKBQa7AHczMrla
# ZgkIf6FpZAjneS1p/ocfs6xy2mLzbVlmog0fjldihWpUWwttltZ4ExMcccgDSSTB
# CD9vBIo3h+AHoreO2iieyhkH+4Kt0SKEaBVkU8EdhjqQoYIS5TCCEuEGCisGAQQB
# gjcDAwExghLRMIISzQYJKoZIhvcNAQcCoIISvjCCEroCAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIEhMRnY5eDjMHQW6jhDoZWIqwdO2g5mwC/6/cMA5
# VF/SAgZd000Grf0YEzIwMTkxMjEzMjI1NjUxLjA1OFowBIACAfSggdCkgc0wgcox
# CzAJBgNVBAYTAlVTMRMwEQYDVQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRt
